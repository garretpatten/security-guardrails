...
Use [GitHub Issues](https://github.com/garretpatten/security-guardrails/issues) with the **Bug report** or **Feature request** form. Include the consumer workflow snippet, failing job logs (redacted), and the pinned workflow ref you use.
